    ...
    const product_details=document.getElementById('desingCollection');
   let tag_value="";
   var products=designList;
    ...
    for(let i=0;i<products.length;i++){
        if(products[i].see==1){
           ...
           Id: ${products[i].designId} 
            ...
            https%3A%2F%2Fsurajitmaji.github.io%2Ftextile%2F${products[i].image}
            `;
            var productPageURL=`design.html?id=${products[i].designId}`;
            ...
            <div class="each-product">
                <a class="image-area" href="${productPageURL}">
                    ...
                    <div class="product-image-area">
                        <img src="${image}" alt="" srcset="" class="product-image">
                    </div>
                </a>
                <div class="details">
